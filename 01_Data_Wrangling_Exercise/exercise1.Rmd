...
```{r Exercise 1.3}
#TODO
# get the flights that were departed between 2:00am and 6:00am
...
### Exercise 4.1 
Currently `dep_time` and `sched_dep_time` are convenient to look at, but hard to compute with because they are not really continuous numbers. To change that, answer the following questions:
